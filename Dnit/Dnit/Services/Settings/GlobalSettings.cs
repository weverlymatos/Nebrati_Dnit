...
namespace Dnit.Core.Services.Settings
{
    public class GlobalSetting
    {
        ...
        private string _baseGatewayCatalogEndpoint;
        ...
        public GlobalSetting()
        {
            ...
            BaseGatewayCatalogEndpoint = DefaultEndpoint;
        ...
        public string BaseGatewayCatalogEndpoint
        {
            get { return _baseGatewayCatalogEndpoint; }
            set
            {
                _baseGatewayCatalogEndpoint = value;
                UpdateGatewayCatalogEndpoint(_baseGatewayCatalogEndpoint);
            }
        }
        ...
        public string GatewayCatalogEndpoint { get; set; }
        ...
        private void UpdateGatewayCatalogEndpoint(string endpoint)
        {
            GatewayCatalogEndpoint = $"{endpoint}";
        }
