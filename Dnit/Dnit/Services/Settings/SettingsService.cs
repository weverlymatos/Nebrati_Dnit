...
namespace Dnit.Core.Services.Settings
{
    public class SettingsService : ISettingsService
    {
        ...
        private const string IdGatewayCatalogBase = "url_catalog";
        ...
        private readonly string UrlGatewayCatalogDefault = GlobalSetting.Instance.BaseGatewayCatalogEndpoint;
        #endregion
        ...
        {
            get => GetValueOrDefault(IdGatewayCatalogBase, UrlGatewayCatalogDefault);
            set => AddOrUpdateValue(IdGatewayCatalogBase, value);
        }
