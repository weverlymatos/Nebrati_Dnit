...
namespace Dnit.Core.ViewModels
{
    public class LoginViewModel : ViewModelBase
    {
        ...
        {
            _userName.Validations.Add(new IsNotNullOrEmptyRule<string> { ValidationMessage = "Um usuário é requerido." });
            _password.Validations.Add(new IsNotNullOrEmptyRule<string> { ValidationMessage = "Uma senha é requerida." });
        }
